...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/update-mgmultiplesecuritytiindicator
schema: 2.0.0
---

# Update-MgMultipleSecurityTiIndicator
...
```
Update-MgMultipleSecurityTiIndicator [-Value <IMicrosoftGraphTiIndicator[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
