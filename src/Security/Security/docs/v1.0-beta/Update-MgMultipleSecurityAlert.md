...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/update-mgmultiplesecurityalert
schema: 2.0.0
---
...
```
Update-MgMultipleSecurityAlert [-Value <IMicrosoftGraphAlert[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
