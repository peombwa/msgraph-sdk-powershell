...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.cloudprint/update-mgprintprinteralloweduser
schema: 2.0.0
---

# Update-MgPrintPrinterAllowedUser
...
```
Update-MgPrintPrinterAllowedUser -PrinterId <String> -PrintUserIdentityId <String> [-DisplayName <String>]
 [-Id <String>] [-IPAddress <String>] [-UserPrincipalName <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgPrintPrinterAllowedUser -PrinterId <String> -PrintUserIdentityId <String>
 -BodyParameter <IMicrosoftGraphPrintUserIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgPrintPrinterAllowedUser -InputObject <IDevicesCloudPrintIdentity>
 -BodyParameter <IMicrosoftGraphPrintUserIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgPrintPrinterAllowedUser -InputObject <IDevicesCloudPrintIdentity> [-DisplayName <String>]
 [-Id <String>] [-IPAddress <String>] [-UserPrincipalName <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### -PrintUserIdentityId
key: printUserIdentity-id of printUserIdentity
