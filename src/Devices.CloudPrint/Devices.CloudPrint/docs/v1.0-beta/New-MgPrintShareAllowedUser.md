...
```
New-MgPrintShareAllowedUser -PrinterShareId <String> [-DisplayName <String>] [-Id <String>]
...
```
New-MgPrintShareAllowedUser -InputObject <IDevicesCloudPrintIdentity> [-DisplayName <String>] [-Id <String>]
 [-IPAddress <String>] [-UserPrincipalName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
