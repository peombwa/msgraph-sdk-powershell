...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.cloudprint/get-mgprintreportprinterarchivedprintjob
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgPrintReportPrinterArchivedPrintJob -PeriodEnd <DateTime> -PeriodStart <DateTime> -PrinterId <String>
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPrintReportPrinterArchivedPrintJob -InputObject <IDevicesCloudPrintIdentity> [<CommonParameters>]
```
