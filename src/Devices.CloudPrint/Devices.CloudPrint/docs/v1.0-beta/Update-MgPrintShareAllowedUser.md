...
```
Update-MgPrintShareAllowedUser -PrinterShareId <String> -PrintUserIdentityId <String> [-DisplayName <String>]
...
```
Update-MgPrintShareAllowedUser -InputObject <IDevicesCloudPrintIdentity> [-DisplayName <String>]
 [-Id <String>] [-IPAddress <String>] [-UserPrincipalName <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
