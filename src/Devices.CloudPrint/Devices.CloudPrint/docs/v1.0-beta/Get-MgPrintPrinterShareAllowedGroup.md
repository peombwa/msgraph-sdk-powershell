...
### List (Default)
```
Get-MgPrintPrinterShareAllowedGroup -PrinterShareId <String> [-Count] [-ExpandProperty <String[]>]
...
### Get
```
Get-MgPrintPrinterShareAllowedGroup -PrinterShareId <String> -PrintIdentityId <String>
