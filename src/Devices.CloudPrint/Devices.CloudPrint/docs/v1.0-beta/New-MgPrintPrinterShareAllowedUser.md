...
```
New-MgPrintPrinterShareAllowedUser -PrinterShareId <String> [-DisplayName <String>] [-Id <String>]
...
```
New-MgPrintPrinterShareAllowedUser -InputObject <IDevicesCloudPrintIdentity> [-DisplayName <String>]
