...
```
New-MgPrintPrinterShareAllowedGroup -PrinterShareId <String> [-DisplayName <String>] [-Id <String>] [-Confirm]
...
```
New-MgPrintPrinterShareAllowedGroup -InputObject <IDevicesCloudPrintIdentity> [-DisplayName <String>]
