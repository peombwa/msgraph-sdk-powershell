...
```
New-MgPrintPrinterAllowedUser -PrinterId <String> [-DisplayName <String>] [-Id <String>] [-IPAddress <String>]
...
```
New-MgPrintPrinterAllowedUser -InputObject <IDevicesCloudPrintIdentity> [-DisplayName <String>] [-Id <String>]
 [-IPAddress <String>] [-UserPrincipalName <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
