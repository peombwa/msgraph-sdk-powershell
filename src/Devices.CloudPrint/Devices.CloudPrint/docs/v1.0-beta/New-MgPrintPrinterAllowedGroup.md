...
```
New-MgPrintPrinterAllowedGroup -PrinterId <String> [-DisplayName <String>] [-Id <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgPrintPrinterAllowedGroup -InputObject <IDevicesCloudPrintIdentity> [-DisplayName <String>]
