...
### List (Default)
```
Get-MgPrintPrinterShareAllowedUser -PrinterShareId <String> [-Count] [-ExpandProperty <String[]>]
...
### Get
```
Get-MgPrintPrinterShareAllowedUser -PrinterShareId <String> -PrintUserIdentityId <String>
