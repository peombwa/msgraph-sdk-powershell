...
```
Update-MgPrintShareAllowedGroup -PrinterShareId <String> -PrintIdentityId <String> [-DisplayName <String>]
...
```
Update-MgPrintShareAllowedGroup -InputObject <IDevicesCloudPrintIdentity> [-DisplayName <String>]
 [-Id <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
