...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'New-MgUserCalendarViewSingleValueExtendedProperty.Recording.json'
...
Describe 'New-MgUserCalendarViewSingleValueExtendedProperty' {
