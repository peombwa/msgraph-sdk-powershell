...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mgusercalendarviewextension
schema: 2.0.0
---
...
### UpdateViaIdentity3
```
Update-MgUserCalendarViewExtension -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphExtension>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgUserCalendarViewExtension -InputObject <ICalendarIdentity> [-Id <String>] [-PassThru] [-Confirm]
