...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mgusercalendarviewcalendar
schema: 2.0.0
---
...
### UpdateViaIdentity3
```
Update-MgUserCalendarViewCalendar -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphCalendar1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgUserCalendarViewCalendar -InputObject <ICalendarIdentity> [-AllowedOnlineMeetingProviders <String[]>]
