...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mgusercalendareventattachment
schema: 2.0.0
---
...
### UpdateViaIdentity2
```
Update-MgUserCalendarEventAttachment -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphAttachment> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgUserCalendarEventAttachment -InputObject <ICalendarIdentity> [-ContentType <String>] [-Id <String>]
