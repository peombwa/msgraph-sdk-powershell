...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mgusercalendarview
schema: 2.0.0
---
...
### Update4
```
Update-MgUserCalendarView -EventId <String> -UserId <String> -BodyParameter <IMicrosoftGraphEvent1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### UpdateViaIdentity4
```
Update-MgUserCalendarView -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1> [-PassThru]
...
```
Update-MgUserCalendarView -InputObject <ICalendarIdentity> [-CalendarId <String>] [-AddressCity <String>]
 [-AddressCountryOrRegion <String>] [-AddressPostalCode <String>] [-AddressState <String>]
 [-AddressStreet <String>] [-AllowNewTimeProposals] [-Attachments <IMicrosoftGraphAttachment[]>]
 [-Attendees <IMicrosoftGraphAttendee[]>] [-BodyContent <String>] [-BodyContentType <String>]
 [-BodyPreview <String>] [-CalendarAllowedOnlineMeetingProviders <String[]>] [-CalendarCanEdit]
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded4, UpdateExpanded5, UpdateExpanded6, UpdateExpanded7, UpdateViaIdentityExpanded4, UpdateViaIdentityExpanded5, UpdateViaIdentityExpanded6, UpdateViaIdentityExpanded7
Aliases:
...
Parameter Sets: Update4, Update5, Update6, Update7, UpdateViaIdentity4, UpdateViaIdentity5, UpdateViaIdentity6, UpdateViaIdentity7
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Update5, UpdateExpanded4, UpdateExpanded5, UpdateExpanded6, UpdateExpanded7, UpdateViaIdentityExpanded4, UpdateViaIdentityExpanded5, UpdateViaIdentityExpanded6, UpdateViaIdentityExpanded7
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Update4, Update5, Update6, Update7, UpdateExpanded4, UpdateExpanded5, UpdateExpanded6, UpdateExpanded7
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Update7, UpdateExpanded7
Aliases:
...
Parameter Sets: UpdateViaIdentity4, UpdateViaIdentity5, UpdateViaIdentity6, UpdateViaIdentity7, UpdateViaIdentityExpanded4, UpdateViaIdentityExpanded5, UpdateViaIdentityExpanded6, UpdateViaIdentityExpanded7
Aliases:
...
```yaml
Type: System.String
Parameter Sets: UpdateExpanded5
Aliases:
