...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mggroupcalendarviewattachment
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgGroupCalendarViewAttachment -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphAttachment> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgGroupCalendarViewAttachment -InputObject <ICalendarIdentity> [-ContentType <String>] [-Id <String>]
