...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/get-mgusercalendarviewmultivalueextendedproperty
schema: 2.0.0
---
...
### GetViaIdentity3
```
Get-MgUserCalendarViewMultiValueExtendedProperty -InputObject <ICalendarIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
