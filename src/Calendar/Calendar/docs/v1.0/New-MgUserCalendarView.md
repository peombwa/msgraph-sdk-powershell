...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/new-mgusercalendarview
schema: 2.0.0
---
...
### Create4
```
New-MgUserCalendarView -UserId <String> -BodyParameter <IMicrosoftGraphEvent1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create5
```
New-MgUserCalendarView -CalendarId <String> -UserId <String> -BodyParameter <IMicrosoftGraphEvent1> [-Confirm]
...
### Create7
```
New-MgUserCalendarView -EventId <String> -UserId <String> -BodyParameter <IMicrosoftGraphEvent1> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
### CreateViaIdentity4
```
New-MgUserCalendarView -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
```
New-MgUserCalendarView -InputObject <ICalendarIdentity> [-CalendarId <String>] [-AddressCity <String>]
 [-AddressCountryOrRegion <String>] [-AddressPostalCode <String>] [-AddressState <String>]
 [-AddressStreet <String>] [-AllowNewTimeProposals] [-Attachments <IMicrosoftGraphAttachment[]>]
 [-Attendees <IMicrosoftGraphAttendee[]>] [-BodyContent <String>] [-BodyContentType <String>]
 [-BodyPreview <String>] [-CalendarAllowedOnlineMeetingProviders <String[]>] [-CalendarCanEdit]
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded4, CreateExpanded5, CreateExpanded6, CreateExpanded7, CreateViaIdentityExpanded4, CreateViaIdentityExpanded5, CreateViaIdentityExpanded6, CreateViaIdentityExpanded7
Aliases:
...
Parameter Sets: Create4, Create5, Create6, Create7, CreateViaIdentity4, CreateViaIdentity5, CreateViaIdentity6, CreateViaIdentity7
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Create5, CreateExpanded4, CreateExpanded5, CreateExpanded6, CreateExpanded7, CreateViaIdentityExpanded4, CreateViaIdentityExpanded5, CreateViaIdentityExpanded6, CreateViaIdentityExpanded7
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Create7, CreateExpanded7
Aliases:
...
Parameter Sets: CreateViaIdentity4, CreateViaIdentity5, CreateViaIdentity6, CreateViaIdentity7, CreateViaIdentityExpanded4, CreateViaIdentityExpanded5, CreateViaIdentityExpanded6, CreateViaIdentityExpanded7
Aliases:
...
```yaml
Type: System.String
Parameter Sets: CreateExpanded5
Aliases:
...
```yaml
Type: System.String
Parameter Sets: Create4, Create5, Create6, Create7, CreateExpanded4, CreateExpanded5, CreateExpanded6, CreateExpanded7
Aliases:
