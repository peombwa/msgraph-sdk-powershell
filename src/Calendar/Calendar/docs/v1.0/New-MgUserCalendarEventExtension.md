...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/new-mgusercalendareventextension
schema: 2.0.0
---
...
### CreateViaIdentity2
```
New-MgUserCalendarEventExtension -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphExtension>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgUserCalendarEventExtension -InputObject <ICalendarIdentity> [-Id <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
