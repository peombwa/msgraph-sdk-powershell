...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/get-mgusercalendargroupcalendarviewextension
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserCalendarGroupCalendarViewExtension -InputObject <ICalendarIdentity> [-ExpandProperty <String[]>]
