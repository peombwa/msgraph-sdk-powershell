...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mgusercalendarviewcalendarevent
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgUserCalendarViewCalendarEvent -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgUserCalendarViewCalendarEvent -InputObject <ICalendarIdentity> [-AddressCity <String>]
