...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mgusercalendareventextension
schema: 2.0.0
---
...
### UpdateViaIdentity2
```
Update-MgUserCalendarEventExtension -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphExtension>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgUserCalendarEventExtension -InputObject <ICalendarIdentity> [-Id <String>] [-PassThru] [-Confirm]
