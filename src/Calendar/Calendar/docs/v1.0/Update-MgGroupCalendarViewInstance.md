...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mggroupcalendarviewinstance
schema: 2.0.0
---
...
### UpdateViaIdentity2
```
Update-MgGroupCalendarViewInstance -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgGroupCalendarViewInstance -InputObject <ICalendarIdentity> [-AddressCity <String>]
