...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/new-mggroupcalendarevent
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgGroupCalendarEvent -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgGroupCalendarEvent -InputObject <ICalendarIdentity> [-AddressCity <String>]
