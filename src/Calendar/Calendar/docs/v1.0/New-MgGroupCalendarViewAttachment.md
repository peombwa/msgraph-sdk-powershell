...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/new-mggroupcalendarviewattachment
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgGroupCalendarViewAttachment -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphAttachment>
...
```
New-MgGroupCalendarViewAttachment -InputObject <ICalendarIdentity> [-ContentType <String>] [-Id <String>]
 [-IsInline] [-LastModifiedDateTime <DateTime>] [-Name <String>] [-Size <Int32>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
