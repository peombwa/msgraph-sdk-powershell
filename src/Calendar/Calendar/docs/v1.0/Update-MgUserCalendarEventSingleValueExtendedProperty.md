...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mgusercalendareventsinglevalueextendedproperty
schema: 2.0.0
---
...
### UpdateViaIdentity2
```
Update-MgUserCalendarEventSingleValueExtendedProperty -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUserCalendarEventSingleValueExtendedProperty -InputObject <ICalendarIdentity> [-Id <String>]
