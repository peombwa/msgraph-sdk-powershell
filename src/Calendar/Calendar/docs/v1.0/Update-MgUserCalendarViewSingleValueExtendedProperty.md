...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mgusercalendarviewsinglevalueextendedproperty
schema: 2.0.0
---
...
### UpdateViaIdentity3
```
Update-MgUserCalendarViewSingleValueExtendedProperty -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUserCalendarViewSingleValueExtendedProperty -InputObject <ICalendarIdentity> [-Id <String>]
