...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/new-mgusercalendargroupcalendarsinglevalueextendedproperty
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgUserCalendarGroupCalendarSingleValueExtendedProperty -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgUserCalendarGroupCalendarSingleValueExtendedProperty -InputObject <ICalendarIdentity> [-Id <String>]
