...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mggroupcalendarviewcalendarmultivalueextendedproperty
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupCalendarViewCalendarMultiValueExtendedProperty -InputObject <ICalendarIdentity>
...
```
Update-MgGroupCalendarViewCalendarMultiValueExtendedProperty -InputObject <ICalendarIdentity> [-Id <String>]
