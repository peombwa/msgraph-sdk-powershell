...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mggroupeventcalendarmultivalueextendedproperty
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgGroupEventCalendarMultiValueExtendedProperty -InputObject <ICalendarIdentity>
...
```
Update-MgGroupEventCalendarMultiValueExtendedProperty -InputObject <ICalendarIdentity> [-Id <String>]
