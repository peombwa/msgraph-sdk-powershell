...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/get-mgusercalendargroupcalendarview
schema: 2.0.0
---
...
### GetViaIdentity1
```
Get-MgUserCalendarGroupCalendarView -InputObject <ICalendarIdentity> [-ExpandProperty <String[]>]
