...
### UpdateViaIdentity1
```
Update-MgUserCalendarGroupCalendarEvent -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphEvent1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgUserCalendarGroupCalendarEvent -InputObject <ICalendarIdentity> [-CalendarId <String>]
