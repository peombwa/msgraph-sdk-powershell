...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mgusercalendarviewattachment
schema: 2.0.0
---
...
### UpdateViaIdentity3
```
Update-MgUserCalendarViewAttachment -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphAttachment> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgUserCalendarViewAttachment -InputObject <ICalendarIdentity> [-ContentType <String>] [-Id <String>]
