...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/new-mgusercalendargroupcalendarviewmultivalueextendedproperty
schema: 2.0.0
---
...
### CreateViaIdentity1
```
New-MgUserCalendarGroupCalendarViewMultiValueExtendedProperty -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphMultiValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgUserCalendarGroupCalendarViewMultiValueExtendedProperty -InputObject <ICalendarIdentity> [-Id <String>]
