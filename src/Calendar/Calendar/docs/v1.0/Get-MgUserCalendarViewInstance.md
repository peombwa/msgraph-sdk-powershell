...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/get-mgusercalendarviewinstance
schema: 2.0.0
---
...
### GetViaIdentity3
```
Get-MgUserCalendarViewInstance -InputObject <ICalendarIdentity> [-ExpandProperty <String[]>]
