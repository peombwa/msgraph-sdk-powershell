...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mggroupeventcalendarevent
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgGroupEventCalendarEvent -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgGroupEventCalendarEvent -InputObject <ICalendarIdentity> [-AddressCity <String>]
