...
### UpdateViaIdentity
```
Update-MgUserEventExtension -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphExtension>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserEventExtension -InputObject <ICalendarIdentity> [-Id <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
