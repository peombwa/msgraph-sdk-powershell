...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mggroupcalendarviewextension
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupCalendarViewExtension -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphExtension>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgGroupCalendarViewExtension -InputObject <ICalendarIdentity> [-Id <String>] [-PassThru] [-Confirm]
