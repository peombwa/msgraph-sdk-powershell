...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/get-mgusercalendargroupcalendareventextension
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserCalendarGroupCalendarEventExtension -InputObject <ICalendarIdentity> [-ExpandProperty <String[]>]
