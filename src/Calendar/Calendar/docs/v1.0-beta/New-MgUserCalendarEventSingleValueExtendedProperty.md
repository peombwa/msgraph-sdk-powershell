...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/new-mgusercalendareventsinglevalueextendedproperty
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgUserCalendarEventSingleValueExtendedProperty -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgUserCalendarEventSingleValueExtendedProperty -InputObject <ICalendarIdentity> [-Id <String>]
 [-Value <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
