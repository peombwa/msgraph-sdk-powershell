...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/new-mgusercalendargroupcalendareventinstance
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgUserCalendarGroupCalendarEventInstance -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphEvent> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserCalendarGroupCalendarEventInstance -InputObject <ICalendarIdentity> [-AddressCity <String>]
