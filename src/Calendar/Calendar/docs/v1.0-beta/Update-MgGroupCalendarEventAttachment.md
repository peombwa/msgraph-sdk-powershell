...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mggroupcalendareventattachment
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupCalendarEventAttachment -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphAttachment> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgGroupCalendarEventAttachment -InputObject <ICalendarIdentity> [-ContentType <String>] [-Id <String>]
