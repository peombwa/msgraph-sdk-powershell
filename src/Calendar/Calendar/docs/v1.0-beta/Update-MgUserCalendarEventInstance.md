...
### UpdateViaIdentity
```
Update-MgUserCalendarEventInstance -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent>
...
```
Update-MgUserCalendarEventInstance -InputObject <ICalendarIdentity> [-AddressCity <String>]
