...
### UpdateViaIdentity
```
Update-MgUserCalendarViewInstance -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent>
...
```
Update-MgUserCalendarViewInstance -InputObject <ICalendarIdentity> [-AddressCity <String>]
