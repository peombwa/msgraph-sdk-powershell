...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/get-mggroupcalendarviewcalendar
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgGroupCalendarViewCalendar -InputObject <ICalendarIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
