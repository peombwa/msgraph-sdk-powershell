...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mggroupcalendareventmultivalueextendedproperty
schema: 2.0.0
---
...
### UpdateViaIdentity1
```
Update-MgGroupCalendarEventMultiValueExtendedProperty -InputObject <ICalendarIdentity>
...
```
Update-MgGroupCalendarEventMultiValueExtendedProperty -InputObject <ICalendarIdentity> [-Id <String>]
