...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/get-mgusercalendargroupcalendareventcalendar
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserCalendarGroupCalendarEventCalendar -InputObject <ICalendarIdentity> [-ExpandProperty <String[]>]
