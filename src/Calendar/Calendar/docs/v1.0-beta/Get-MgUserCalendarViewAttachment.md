...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/get-mgusercalendarviewattachment
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserCalendarViewAttachment -InputObject <ICalendarIdentity> [-ExpandProperty <String[]>]
