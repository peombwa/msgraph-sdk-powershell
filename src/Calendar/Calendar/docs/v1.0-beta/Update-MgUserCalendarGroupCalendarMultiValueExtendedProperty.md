...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mgusercalendargroupcalendarmultivalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgUserCalendarGroupCalendarMultiValueExtendedProperty -CalendarGroupId <String> -CalendarId <String>
...
### UpdateViaIdentity
```
Update-MgUserCalendarGroupCalendarMultiValueExtendedProperty -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphMultiValueLegacyExtendedProperty> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUserCalendarGroupCalendarMultiValueExtendedProperty -InputObject <ICalendarIdentity> [-Id <String>]
