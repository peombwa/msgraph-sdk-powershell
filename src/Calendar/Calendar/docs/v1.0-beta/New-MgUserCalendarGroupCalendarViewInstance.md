...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/new-mgusercalendargroupcalendarviewinstance
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgUserCalendarGroupCalendarViewInstance -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphEvent> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserCalendarGroupCalendarViewInstance -InputObject <ICalendarIdentity> [-AddressCity <String>]
