...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/get-mgusercalendargroupcalendarmultivalueextendedproperty
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserCalendarGroupCalendarMultiValueExtendedProperty -InputObject <ICalendarIdentity>
