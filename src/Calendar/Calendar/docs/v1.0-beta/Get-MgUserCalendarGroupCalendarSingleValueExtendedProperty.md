...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/get-mgusercalendargroupcalendarsinglevalueextendedproperty
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserCalendarGroupCalendarSingleValueExtendedProperty -InputObject <ICalendarIdentity>
