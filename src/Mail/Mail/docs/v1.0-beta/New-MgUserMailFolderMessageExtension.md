...
### CreateViaIdentity1
```
New-MgUserMailFolderMessageExtension -InputObject <IMailIdentity> -BodyParameter <IMicrosoftGraphExtension>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgUserMailFolderMessageExtension -InputObject <IMailIdentity> [-Id <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
