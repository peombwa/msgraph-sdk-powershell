...
### CreateViaIdentity1
```
New-MgUserMessageExtension -InputObject <IMailIdentity> -BodyParameter <IMicrosoftGraphExtension> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgUserMessageExtension -InputObject <IMailIdentity> [-Id <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
