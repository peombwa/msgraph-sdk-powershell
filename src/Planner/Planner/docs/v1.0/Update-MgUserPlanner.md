...
```
Update-MgUserPlanner -UserId <String> [-Id <String>] [-Plans <IMicrosoftGraphPlannerPlan[]>]
...
```
Update-MgUserPlanner -InputObject <IPlannerIdentity> [-Id <String>] [-Plans <IMicrosoftGraphPlannerPlan[]>]
 [-Tasks <IMicrosoftGraphPlannerTask[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
