...
Update-MgPrivilegedAccessRoleAssignmentRequest -GovernanceRoleAssignmentRequestId <String>
 -PrivilegedAccessId <String> [-AssignmentState <String>] [-Id <String>]
 [-LinkedEligibleRoleAssignmentId <String>] [-MicrosoftGraphEntityId <String>]
 ...
 [-SubjectPrincipalName <String>] [-SubjectType <String>] [-Type <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
key: governanceRoleAssignmentRequest-id of governanceRoleAssignmentRequest
