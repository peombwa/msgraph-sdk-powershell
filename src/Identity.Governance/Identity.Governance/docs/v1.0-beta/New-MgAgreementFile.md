...
### CreateViaIdentity
```
New-MgAgreementFile -InputObject <IIdentityGovernanceIdentity> -BodyParameter <IMicrosoftGraphAgreementFile>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgAgreementFile -InputObject <IIdentityGovernanceIdentity> [-FileDataDataInputFile <String>]
